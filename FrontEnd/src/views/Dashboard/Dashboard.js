...
const cardChartData1 = {
  labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July','3asba'],
  datasets: [
    {
...
class Dashboard extends Component {
  ...
  loading = () => <div className="animated fadeIn pt-1 text-center">Calculating Energy...</div>
              ...
              <CardFooter>
                <Row className="text-center">
                  ...
                  <Col sm={12} md className="mb-sm-2 mb-0">
                    ...
                    <Progress className="progress-xs mt-2" color="danger" value="8" />
                  </Col>
                  <Col sm={12} md className="mb-sm-2 mb-0 d-md-down-none">
